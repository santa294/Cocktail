...
public class FirstLetterActivityB extends AppCompatActivity {
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            cocktailAdapter = new CocktailAdapter(FirstLetterActivityB.this,cocktails);
    ...
    public void onBackPressed() {
        startActivity(new Intent(FirstLetterActivityB.this,MainActivity.class));
        finish();
    }
