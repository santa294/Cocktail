...
public class FirstLetterActivityU extends AppCompatActivity {
    ...
    private void getCocktails() {
        String url = "https://www.thecocktaildb.com/api/json/v1/1/search.php?f=u";
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            cocktailAdapter = new CocktailAdapter(FirstLetterActivityU.this,cocktails);
    ...
    public void onBackPressed() {
        startActivity(new Intent(FirstLetterActivityU.this,MainActivity.class));
        finish();
    }
