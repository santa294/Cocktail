...
public class FirstLetterActivityP extends AppCompatActivity {
    ...
    private void getCocktails() {
        String url = "https://www.thecocktaildb.com/api/json/v1/1/search.php?f=p";
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            cocktailAdapter = new CocktailAdapter(FirstLetterActivityP.this,cocktails);
    ...
    public void onBackPressed() {
        startActivity(new Intent(FirstLetterActivityP.this,MainActivity.class));
        finish();
    }
