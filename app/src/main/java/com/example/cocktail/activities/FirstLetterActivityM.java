...
public class FirstLetterActivityM extends AppCompatActivity {
    ...
    private void getCocktails() {
        String url = "https://www.thecocktaildb.com/api/json/v1/1/search.php?f=m";
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            cocktailAdapter = new CocktailAdapter(FirstLetterActivityM.this,cocktails);
    ...
    public void onBackPressed() {
        startActivity(new Intent(FirstLetterActivityM.this,MainActivity.class));
        finish();
    }
