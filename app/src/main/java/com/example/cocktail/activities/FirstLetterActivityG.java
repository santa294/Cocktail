...
public class FirstLetterActivityG extends AppCompatActivity {
    ...
    private void getCocktails() {
        String url = "https://www.thecocktaildb.com/api/json/v1/1/search.php?f=g";
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            cocktailAdapter = new CocktailAdapter(FirstLetterActivityG.this,cocktails);
    ...
    public void onBackPressed() {
        startActivity(new Intent(FirstLetterActivityG.this,MainActivity.class));
        finish();
    }
